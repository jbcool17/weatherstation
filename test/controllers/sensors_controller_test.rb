...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { api_key: @sensor.api_key, location: @sensor.location, name: @sensor.name } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { api_key: @sensor.api_key, location: @sensor.location, name: @sensor.name } }
